...
class GeolocationApi {
    ...
    public function request($postalCode, $country) {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'http://nominatim.openstreetmap.org/search?postalcode='.urlencode($postalCode).'&country='.urlencode($country).'&format=json&addressdetails=1&accept-language='.urlencode($this->local));
